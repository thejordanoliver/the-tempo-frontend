...
export default function CFBDrivesList({
  previousDrives,
  currentDrives,
  loading,
  error,
    ...
    <View>
      <ScrollView style={{ maxHeight: 400 }}>
        <FlatList
          ...
          scrollEnabled={false}
          renderItem={({ item }) => {
            // ✅ Prefer light logo when lighter is true, fallback to normal
            const logo =
              (lighter ? getTeamLogo(item.team.abbreviation, true) : null) ||
              getTeamLogo(item.team.abbreviation, false);
