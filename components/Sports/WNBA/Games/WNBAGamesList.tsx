...
import WNBAGamePreviewModal from "../GamePreview/WNBAGamePreviewModal";
import WNBAGameCard from "./WNBAGameCard";
import WNBASquareGameCard from "./WNBASquareGameCard";
import WNBAStackedGameCard from "./WNBAStackedGameCard";
type Props = {
  games: any[];
  loading: boolean;
  refreshing: boolean;
...
type WNBAGameSection = {
  title: string;
  data: any[];
};

export default function WNBAGamesList({
  games,
  loading,
  refreshing,
  onRefresh,
  ...
  const sections: WNBAGameSection[] = useMemo(() => {
  ...
  return (
    <>
      {viewMode === "grid" ? (
        ...
        <SectionList
          sections={sections as SectionListData<any, WNBAGameSection>[]}
