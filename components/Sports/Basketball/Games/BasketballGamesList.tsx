...
import CBBSquareGameCard from "./BasketballSquareGameCard";
import CBBStackedGameCard from "./BasketballStackedGameCard";
...
export default function BasketballGamesList({
  games,
  loading,
  refreshing,
  onRefresh,
  ...
  const isCBBGame = (game: any) => String(game?.league?.id) === "116";
  const isWCBBGame = (game: any) => String(game?.league?.id) === "423";
  const isWNBAGame = (game: any) => String(game?.league?.id) === "13";
