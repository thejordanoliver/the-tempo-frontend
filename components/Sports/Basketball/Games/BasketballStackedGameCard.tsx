...
function BasketabllStackedGameCard({
  game,
  isCBB = false,
  isWCBB = false,
  isWNBA = false,
  ...
  const homeName = home?.fullName ?? game?.teams?.home.name;
  const awayName = away?.fullName ?? game?.teams?.away.name;
...
export default memo(BasketabllStackedGameCard);
