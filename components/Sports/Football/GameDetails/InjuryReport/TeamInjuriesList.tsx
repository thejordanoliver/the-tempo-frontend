...
const findMatchingPlayer = (
  ...
  return teamPlayers.find((player) => normalizeId(player.id) === athleteId);
};
...
const getTeamPlayers = (
  ...
  const localTeam = getNFLTeamByESPNId(teamId);

  const possibleKeys = [normalizeId(teamId), normalizeId(localTeam?.id)].filter(
